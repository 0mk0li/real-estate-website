...
class Profile(TimeStampedUUIDModel):
    ...
    is_buyer = models.BooleanField(
        verbose_name=_("Buyer"), default=False, help_text="Looking for a property?"
    )
    is_seller = models.BooleanField(
        verbose_name=_("Seller"),
        default=False,
        help_text="Want to sell property at right price?",
    )
    is_agent = models.BooleanField(
        verbose_name=_("Agent"), default=False, help_text="Work with us?"
    )
